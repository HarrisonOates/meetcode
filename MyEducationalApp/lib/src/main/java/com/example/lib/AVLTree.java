...
public class AVLTree <T extends Comparable<T>> {
    ...
    public static void main(String[] args) {
        ...
        Integer[] nodes = new Integer[]{4,3,2,5,6,-1,10,9,7};
        ...
        System.out.println(tree.root.left.getHeight());
        System.out.println(tree.root.getBalanceFactor());
        System.out.println(tree.root.right.getBalanceFactor());
        System.out.println(tree.root.left.getBalanceFactor());
